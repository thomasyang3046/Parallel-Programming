...
void usage(const char *progname);//done
void initValue(float *values, int *exponents, float *output, float *gold, unsigned int N);//done 隨機生成數字
...
bool verifyResult(float *values, int *exponents, float *output, float *gold, int N);//done
